// Inline SVG icon components — consistent 24x24 viewBox, Lucide-compatible
// Usage: <QrCodeIcon className="w-5 h-5" />

type IconProps = React.SVGProps<SVGSVGElement> & { size?: number };

const icon = (paths: React.ReactNode) =>
    function Icon({ size = 20, className = "", style, ...rest }: IconProps) {
        return (
            <svg
...
export const QrCodeIcon = icon(
    <>
        ...
        <path d="M14 14h2v2h-2z M18 14h3v2h-3z M14 18h2v3h-2z M18 18h3v3h-3z" fill="currentColor" stroke="none" />
    </>
);
